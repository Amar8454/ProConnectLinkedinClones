    ...
    <>
      <div className="container">
        <div className={style.HomeContainer}>
          <div className={style.Home_left_container}>
            <div
          ...
          <div className={style.Home_feed_cotainer}>{children}</div>

          <div className={style.Home_Extra_contianer}>
            <h3> Top Profile</h3>
        ...
        <div className={style.mobileNavbar}>
          <div
            className={style.singleNavItesm}
            onClick={() => router.push("/dashboard")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
